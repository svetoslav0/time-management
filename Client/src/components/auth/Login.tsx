    ...
    return (
        <div className='mx-auto flex max-w-sm flex-col gap-6 p-5'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <InputComponent error={errors.username?.message} register={register} trigger={trigger} field='username' />
                <InputComponent error={errors.password?.message} register={register} trigger={trigger} field='password' type='password' />
                <button
                    type='submit'
